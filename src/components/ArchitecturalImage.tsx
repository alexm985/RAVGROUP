...
export const REALISTIC_IMAGE_MAP: Record<ArchitecturalImageType, string> = {
  ...
  'chalet':
    'https://images.unsplash.com/photo-1449158743715-0a90ebb6d2d8?auto=format&fit=crop&w=1100&q=80',
  'farmhouse':
    'https://images.unsplash.com/photo-1587061949409-02df41d5e562?auto=format&fit=crop&w=1100&q=80',
  'commercial':
  ...
  'mountain':
    'https://images.unsplash.com/photo-1502784444187-359ac186c5bb?auto=format&fit=crop&w=1100&q=80',
  'construction':
...
export const ArchitecturalImage: React.FC<ArchitecturalImageProps> = ({
  ...
  const imageUrl = customSrc || REALISTIC_IMAGE_MAP[type] || REALISTIC_IMAGE_MAP['hero-resort'];
